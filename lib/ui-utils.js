...
define((require, exports, module) => {
	...
	// Shows the run workflow button if the current document is markdown; otherwise hides it
	...
	const initialiseEventHandling = () => {
		onClickRunworkflowButton(workflowUtils.runWorkflow);
		onClickRunworkflowButton(R.pipe(R.T, toggleSpinnerRunWorkflow));
